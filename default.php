...
<!-- Implementação da API JS de Mapa do Google -->
...
<?php
	//pega um array de campos extras
	$fields = $this->contact->jcfields;

	foreach($fields as $field){
		$objects[] = $field;
	}

	$cord = $objects[0]->value;
	$zoom = $objects[1]->rawvalue;

	$mark = explode(',',$cord);

	// Objeto que manipula os documentos Joomla
	...
	$document->addScriptDeclaration('
      function initMap() {
		  var uluru = {lat: '.$mark[0].', lng: '.$mark[1].'};
